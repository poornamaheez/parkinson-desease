...
main = tkinter.Tk()
main.title("Parkinsons Disease Prediction using Machine Learning")
...
def graph():
    ...
    plt.legend(['Image ML Training Accuracy', 'Image ML Training Loss', 'Voice ML Training Accuracy','Voice ML Training Loss'], loc='upper left')
    plt.title('Image & Loss ML Training Accuracy & Loss Graph')
    plt.show()
...
# main = Tk()
font = ('times', 16, 'bold')
main.title("Parkinson's Disease Prediction using Machine Learning")
main.geometry("800x600")

# Create a frame for the title
title_frame = Frame(main, bg='#f79797')
title_frame.pack(fill=X)  # Make the frame occupy the whole width of the window

# Create the title label
title_label = Label(title_frame, text='Parkinsons Disease Prediction using Machine Learning', bg='#f79797', fg='white', font=font)
title_label.pack(pady=5)  # Add padding to the top and bottom to center the title vertically

# title = Label(main, text='Parkinsons Disease Prediction using Machine Learning',anchor=W, justify=CENTER)
# title.config(bg='#f79797', fg='white')  
# title.config(font=font)           
# title.config(height=3, width=10)       
# title.place(x=0,y=5)
